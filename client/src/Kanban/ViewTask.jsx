...
function ViewTask(props) {
    ...
    return (
        <div className="fixed inset-0 bg-[#1e293b]/50 backdrop-blur-sm flex justify-center items-center z-[100]">
            
            <div className="relative bg-[#f1f5f9]/95 rounded-2xl p-8 max-w-5xl w-full shadow-xl h-[85vh] overflow-y-auto border-l-6 border-[#2dd4bf] z-[20]">
